...
% Print time
fprintf('RNetoworks95.m started: %s\n', datestr(datetime('now')))
...
if isfile('fig6_Rdistro95.csv')
    fprintf('Deleting previous fig6_Rdistro95.csv...\n')
    delete 'fig6_Rdistro95.csv';
end
...
parfor iIteration = 1:nIterationsTotal
    ...
    dlmwrite('fig6_Rdistro95.csv', mean(R), '-append')
    fprintf('%d\n', iIteration);

end

% Print time
fprintf('RNetoworks95.m finished: %s\n', datestr(datetime('now')))
