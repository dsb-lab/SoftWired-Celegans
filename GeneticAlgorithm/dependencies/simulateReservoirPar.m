function states = simulateReservoirPar(population, inputs)
% 
% Function: 
% – simulateReservoirPar :Simulates reservoir activity using a discrete map. 
%   Parallel computing used.
%
% Inputs:
...
parfor iIndividual = 1:length(population)
